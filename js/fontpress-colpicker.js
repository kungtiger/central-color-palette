...
Rewrite of Jose Vargas colpicker - github.com/josedvq/colpick-jQuery-Color-Picker

Copyright: 2019 Daniel Schneider - github.com/kungtiger/colpicker
License: GPLv2
Version: 1.0
 */
				...
				return this.each(function () {
					...
					if (!$(this).data('colpickId')) {
                        ...
                        if ($.isArray(options.palette) && options.palette.length) {
                            ...
                            cal.css('paddingBottom', Math.ceil(options.palette.length / per_row) * color_size);
                            $palette.on('mousedown', '.colpick_palette_color', function() {
                                colpick.setColor.call(cal, $(this).data('color'));
                            });
                        }
